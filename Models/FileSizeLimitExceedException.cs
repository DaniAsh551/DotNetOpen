...
namespace Dani551.Open.FileService
{
    public class FileSizeLimitExceedException : Exception
    {
        ...
        public FileSizeLimitExceedException(long maxAllowedFileSize, long attemptedFileSize) : base("The File size exceeds the Maximum Allowed file size by the Configuration")
        {
