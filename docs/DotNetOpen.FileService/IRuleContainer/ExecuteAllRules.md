# IRuleContainer.ExecuteAllRules method (1 of 2)
...
| --- | --- |
| fileServiceConfig | The [`IFileService`](../IFileService.md) against which the files should be validated. |
...
# IRuleContainer.ExecuteAllRules method (2 of 2)
